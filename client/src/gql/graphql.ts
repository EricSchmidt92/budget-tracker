...
export type BudgetQuery = { __typename?: 'Query', budget: { __typename?: 'Budget', currentAmount: string, description?: string | null, id: string, maxAmount: string, name: string, categories: Array<{ __typename?: 'Category', name: string, maxAmount: string, id: string, currentAmount: string, budgetItems: Array<{ __typename?: 'BudgetItem', amount: string, dueDate?: string | null, id: string, name: string, note?: string | null, paid: boolean, paidDate?: string | null }> }> } };
